...
public class JTableUtils {
    ...
    public static void initJTableForArray(
        ...
        int changeButtonsSize, int changeButtonsMargin, boolean areCellsEditable
    ) {
    ...
    /**
     * Аналогичен {@link #initJTableForArray(JTable, int, boolean, boolean, boolean, boolean, int, int, boolean) }.
     ...
     *
     * @see #initJTableForArray(JTable, int, boolean, boolean, boolean, boolean, int, int, boolean)
     */
    public static void initJTableForArray(
        JTable table, int defaultColWidth,
        boolean showRowsIndexes, boolean showColsIndexes,
        boolean changeRowsCountButtons, boolean changeColsCountButtons, boolean areCellsEditable
    ) {
        initJTableForArray(
            table, defaultColWidth,
            showRowsIndexes, showColsIndexes, changeRowsCountButtons, changeColsCountButtons,
            22, DEFAULT_GAP, areCellsEditable
        );
    }
